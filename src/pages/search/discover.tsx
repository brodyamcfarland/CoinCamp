...
const discover = () => {
    ...
    return (
        <Layout>
            ...
            <div className="flex flex-col bg-gradient-to-r from-black/10 to-black border border-gray-900 mt-5 max-w-6xl mx-auto p-2 md:p-10 text-center items-center justify-center tracking-wide">
                            ...
                            {allFunds?.map((fund: any, i: number) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-left border border-gray-900 divide-x-[1px] divide-gray-900">
                                        <p className="tracking-widest font-bold uppercase text-sm px-2">
                                            Time Left
                                        </p>
