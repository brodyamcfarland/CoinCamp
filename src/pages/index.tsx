          ...
          <Layout>
               ...
               <div className="mainContainer">
                    ...
                    <p className="text-gray-300 pt-10 font-bold">
                         Welcome to Coin Camp, the platform for crowd funding
                         with crypto currency.
                    </p>
                    <p className="text-gray-400 pt-10 text-sm lg:px-20 text-left">
                         Coin Camp is a crowdfunding platform where users can
                         either donate to or create a crowdfund using the native
                         cryptocurrency MATIC. Users will be required to have
                         Meta Mask installed and be connected to the Polygon -
                         Mumbai Test Network in order to interact.
                    </p>
                    <p className="text-gray-400 pt-10 text-sm lg:px-20 text-left">
                         To get started, click on "CONNECT WALLET" while
                         connected to the Polygon - Mumbai Test Network. Start
                         searching by using the search bar or click on the
                         navigation button{" "}
